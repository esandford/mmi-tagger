...
datafile="./realPlanets/allFeatures_2classes/realKOIs_allFeatures.txt"
...
for i in `seq $istart $iend`; do
    ...
    #echo $randIdx
    echo $i
    modelfile="./realPlanets/allFeatures_2classes/example-sim-model_realKOIs_allFeatures_seed="$i
